...
pub(crate) fn world_query_impl(
    ...
    quote! {
        ...
        unsafe impl #user_impl_generics #path::query::WorldQuery
            ...
            fn init_state(initializer: &mut #path::world::World) -> #state_struct_name #user_ty_generics {
                #state_struct_name {
                    #(#named_field_idents: <#field_types>::init_state(initializer),)*
                }
            }

            fn get_state(world_cell: #path::world::unsafe_world_cell::UnsafeWorldCell) -> Option<#state_struct_name #user_ty_generics> {
                Some(#state_struct_name {
                    #(#named_field_idents: <#field_types>::get_state(world_cell)?,)*
                })
            }
