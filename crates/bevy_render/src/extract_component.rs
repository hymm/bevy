...
impl<C: for<'a> Component<Ref<'a> = &'a C> + ShaderType + WriteInto + Clone> Plugin
    for UniformComponentPlugin<C>
{
...
fn prepare_uniform_components<C: for<'a> Component<Ref<'a> = &'a C>>(
