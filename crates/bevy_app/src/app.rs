use crate::{
    plugin::WorldPluginExt, world_ext::WorldAppExt, Main, MainSchedulePlugin, Plugin, Plugins,
};
pub use bevy_derive::AppLabel;
use bevy_ecs::{
    prelude::*,
    schedule::{InternedScheduleLabel, IntoSystemSetConfigs, ScheduleBuildSettings, ScheduleLabel},
};
...
impl Default for App {
    fn default() -> Self {
        ...
        app.world.add_plugin(MainSchedulePlugin);

        app.world.add_event::<AppExit>();
...
impl App {
    ...
    pub fn empty() -> App {
        ...
        world.init_resource_inner::<Schedules>();
        Self {
            world,
...
mod tests {
    ...
    use crate::{world_ext::WorldAppExt, App, Plugin};
    ...
    fn regression_test_10385() {
        ...
        let mut app = App::new();
        app.world.add_systems(PreUpdate, my_system);
        app.set_runner(my_runner).run();
    }
}
